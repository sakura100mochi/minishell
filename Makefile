...
#    Updated: 2023/09/21 14:54:50 by hiraiyuina       ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSERSRC	= parser_main.c split_pipe.c list_new.c list_add_back.c parser_contents.c ft_bzero_double.c make_add_node.c
